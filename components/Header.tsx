...
export default function Header() {
  return (
    <div className="w-full border-b bg-white text-gray-800">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-3 space-y-4 md:space-y-0">
        ...
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Artistly</h1>
        </div>
